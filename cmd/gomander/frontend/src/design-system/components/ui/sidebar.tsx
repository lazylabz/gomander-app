...
import { useIsMobile } from "@/design-system/hooks/use-mobile.ts";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: src/design-system/components/ui/sidebar.tsx:114:29
