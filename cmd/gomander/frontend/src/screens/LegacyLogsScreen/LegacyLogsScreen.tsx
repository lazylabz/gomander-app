...
import {
	extractMatchesIds,
	parseLog,
} from "@/screens/LegacyLogsScreen/helpers.ts";
	...
	return (
		<div className="p-4 overflow-y-auto h-full w-full flex flex-col font-mono justify-end bg-background text-foreground">
			...
			{parsedLogs.map((log, index) => (
				// biome-ignore lint/suspicious/noArrayIndexKey: logs are append-only and never reordered
